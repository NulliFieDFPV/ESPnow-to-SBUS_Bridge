...
#define WIFI_PASS        "XXXXXXXXXX"  //your local network password for OTA updates
...
After bootup the ESP connects for 120s to the local network like specified in 2.. ArduinoIDE should automatically detect wifi client and should be selectable as device. If thats not the case, follow step 3.
